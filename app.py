        ...
        with st.spinner(f"Analyzing {image_type.lower()}..."):
            try:
                ...
                if response.status_code == 200:
                    ...
                    # --- NEW: Show the PDF Download Button ---
                    st.divider()
